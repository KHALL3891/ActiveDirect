...
<p>
First, We set up our Domain Controller ruuning Windows Server 22 and the Client VM running Windows 10 PRO. Once that was completed, we then configured and enabled
